						...
						<div class="contact-form">
							<form method="post" action="http://localhost:8080/_war_exploded/register_program" id="contact-form">
                                <div class="form-group">
                                    学号<input type="text" name="Student_ID" maxlength="10" placeholder="输入学号" required="">
                                </div>
								<div class="form-group">
                                    联系方式<input type="text" name="phone" maxlength="15" placeholder="输入联系方式" required="">
                                </div>
		                        <div class="form-group">
                                    昵称<input type="text" name="UName" maxlength="8" placeholder="输入昵称" required="">
                                </div>
                                
                                <div class="form-group">
                                    密码<input type="password" name="pwd1" placeholder="输入密码" required="">
                                </div>
                                
                                <div class="form-group">
                                    <input type="password" name="pwd2" placeholder="确认密码" required="">
                                </div>
                                <div class="form-group text-right">
                                    <button class="theme-btn btn-style-two">
                                        <span class="btn-box"><span class="btn-txt">注册</span><i class="btn-arrow fal fa-arrow-right"></i></span>
                                    </button>
                                </div>
                ...
                <div class="social-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <ul class="social-links">
                            <li><a href="login.jsp">login <span class="arrow fa-solid fa-arrow-right fa-fw"></span></a></li>
