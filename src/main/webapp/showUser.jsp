                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <li>
                            ...
                            <a href="${pageContext.request.contextPath}/showStudentByPage?currentPage=${pb.currentPage - 1}&rows=5&Student_Name=${condition.Student_Name[0]}&Major=${condition.Major[0]}&Strong_point=${condition.Strong_point[0]}" aria-label="Previous">
                        ...
                        <c:forEach begin="1" end="${pb.totalPage}" var="i">
                            <c:if test="${pb.currentPage == i}">
                                <li class="active">
                                    <a href="${pageContext.request.contextPath}/showStudentByPage?currentPage=${i}&rows=5&Student_Name=${condition.Student_Name[0]}&Major=${condition.Major[0]}&Strong_point=${condition.Strong_point[0]}">${i}</a>
                                </li>
                            </c:if>
                            <c:if test="${pb.currentPage != i}">
                                <li>
                        ...
                        <li>
                            ...
                            <a href="${pageContext.request.contextPath}/showStudentByPage?currentPage=${pb.currentPage + 1}&rows=5&Student_Name=${condition.Student_Name[0]}&Major=${condition.Major[0]}&Strong_point=${condition.Strong_point[0]}" aria-label="Next">
