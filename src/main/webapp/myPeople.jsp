                                ...
                                <tbody style="font-size: 18px">
                                    <c:forEach items="${people_list}" var="student">
                                        <tr ng-repeat="data in information | filter:search">
                                            ...
                                            <td>
                                                <span class="fa fa-trash" aria-hidden="true" ng-click="deleteInfo(data)"style="text-align: center;"><br><small><a href="javascript:remove('${student.getStudent_ID()}','${student.getStudent_Name()}')">移出队伍</a></small></span>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
